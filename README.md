...
## Постановка задачи.
В данной лабораторной работе нужно создать ML-агент и научиться тренировать нейросеть, которая впоследствии будет управлять шаром. Шар же в свою очередь должен находить кубик, перемещающийся в заданном случайном диапазоне координат.
...
![2](https://user-images.githubusercontent.com/114507692/198088359-099592c7-3760-437a-8c19-1d94f5151a73.png)
...
https://user-images.githubusercontent.com/114507692/198088985-d0455444-a896-4bec-bced-2159a72ae929.mp4
...
В файле `rollerball config.yaml` содержится конфигурация тренера YAML, в которой находятся все значения гиперпараметров. 
...
Я выбрала вариант различия по имени.
...
https://user-images.githubusercontent.com/114507692/198092830-5044b5bf-dde1-4f69-b078-06bd132d91ef.mp4
...
Для выполнения задания №2 я изучила документацию по созданию тренера агента. Эта "теория" пригодилась мне при работе с заданием №3.

Для задания №3 необходимо было научить агент различать игровые объекты. Цвет придает им Material. Мною был выбран подход инкапсуляции тега GameObject/имени GameObject. Далее в скрипт была добавлена логика вознаграждения при условии, что тег или имя объекта не совпадало с последним пораженным объектом.
